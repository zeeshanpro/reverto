...
class Main extends MY_Shop_Controller
{
    ...
    public function index()
    {
        ...
        redirect('admin');// added to load admin dashboard by default 
        /*==============================================================================
        =            below lines commented to hide the shop page as defualt            =
        ==============================================================================*/
        ...
        /*=====  End of below lines commented to hide the shop page as defualt  ======*/
