        ...
        <div class="box">
            ...
            <div class="box-content">
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bblue white quick-button small" href="<?= admin_url('products/add') ?>">
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bdarkGreen white quick-button small" href="<?= admin_url('sales/add') ?>">
                        <i class="fa fa-plus-circle"></i>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="blightOrange white quick-button small" href="<?= admin_url('quotes/add') ?>">
                        <i class="fa fa-plus-circle"></i>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bred white quick-button small" href="<?= admin_url('purchases/add') ?>">
                        <i class="fa fa-plus-circle"></i>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bpink white quick-button small" href="<?= admin_url('transfers/add') ?>">
                        <i class="fa fa-plus-circle"></i>
